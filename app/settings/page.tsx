    ...
    >
      ...
      <div className="flex flex-col px-5 gap-6 pb-16">
        ...
        <div>
          ...
          <div className="bg-white rounded-[20px] overflow-hidden shadow-sm">
            <SettingsRow
              icon={
                <svg width="20" height="20" fill="none" viewBox="0 0 24 24">
                  <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" stroke="#0D0D0D" strokeWidth="2" strokeLinecap="round"/>
                  <circle cx="9" cy="7" r="4" stroke="#0D0D0D" strokeWidth="2"/>
                  <path d="M23 21v-2a4 4 0 0 0-3-3.87" stroke="#0D0D0D" strokeWidth="2" strokeLinecap="round"/>
                  <path d="M16 3.13a4 4 0 0 1 0 7.75" stroke="#0D0D0D" strokeWidth="2" strokeLinecap="round"/>
                </svg>
              }
              label="Join Community"
              sublabel="Connect with other TBH users"
              onClick={() => window.open('https://discord.gg/tbh', '_blank')}
              divider
            />
            <SettingsRow
              icon={
                <svg width="20" height="20" fill="none" viewBox="0 0 24 24">
                  <path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028c.462-.63.874-1.295 1.226-1.994a.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03z" fill="#0D0D0D"/>
                </svg>
              }
              label="Follow us on Discord"
              sublabel="Stay updated with TBH news"
              onClick={() => window.open('https://discord.gg/tbh', '_blank')}
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="bg-white rounded-[20px] overflow-hidden shadow-sm">
            <SettingsRow
              icon={<img src="/assets/social_media_icons/IG_icon.svg" className="w-5 h-5 object-contain" />}
              label="Instagram"
              sublabel="@tbhonest"
            ...
            />
            <SettingsRow
              icon={<img src="/assets/social_media_icons/snapshat_icon.svg" className="w-5 h-5 object-contain" />}
              label="Snapchat"
              sublabel="@tbhonest"
              onClick={() => window.open('https://snapchat.com/add/tbhonest', '_blank')}
              divider
            />
            <SettingsRow
              icon={<img src="/assets/social_media_icons/Platform=WhatsApp, Color=Original.svg" className="w-5 h-5 object-contain" />}
              label="WhatsApp Channel"
              sublabel="Join our WhatsApp updates"
              onClick={() => window.open('https://whatsapp.com/channel/tbhonest', '_blank')}
            />
          </div>
        </div>
