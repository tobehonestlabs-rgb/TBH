            ...
            {recipient && (
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                <div style={{
                  ...
                  border: `3px solid ${accentColor}`, background: '#333',
                }}>
                  {recipient.pfp
          ...
          <div style={{
            ...
            {recipient?.pfp && (
              <div style={{
                ...
                overflow: 'hidden', border: `3px solid ${accentColor}`, marginBottom: '16px',
              }}>
            ...
            <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.45)', textAlign: 'center', margin: 0 }}>
